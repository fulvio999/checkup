...
Page {
     ...
     Flickable {
            ...
            anchors {
                 ...
                 left: parent.left
                 right: parent.right
                 bottom:  weightPageTablet.bottom
                ...
                Row{
                 ...
                 Row{
                    ...
                    TextArea {
                        ...
                        height: units.gu(15)
                        width: insertValueRow.width - noteLabel.width - units.gu(2)
                        readOnly: false
                    }
                 }
                ...
                Row{
                    ...
                    Button {
                       ...
                       onClicked: {
                          ...
                          pageStack.push(weightDiaryPage)
                       }
                    }
                    ...
                    Button {
                        ...
                        onClicked: {
                           pageStack.push(weightAnaliticPage)
                        }
                    }
                }
           } //col
   ...
   /* To show a scrolbar on the side */
    Scrollbar {
        flickableItem: weightPageTabletFlickable
