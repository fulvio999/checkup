...
/*
  MyDoctor MAIN PAGE for PHONE
*/
Page {
     id: myDoctorPagePhone
     visible: false
     ...
     Flickable {
          ...
          anchors {
                 ...
                 left: parent.left
                 right: parent.right
                 bottom: myDoctorPagePhone.bottom
                ...
                Row{
                 ...
                 Row{
                    ...
                    TextArea {
                        ...
                        textFormat:TextEdit.AutoText
                        height: units.gu(12)
                        width: myDoctorPagePhone.width - units.gu(5)
                        readOnly: false
   ...
   /* To show a scrolbar on the side */
    Scrollbar {
        flickableItem: myDoctorPagePhoneFlickable
