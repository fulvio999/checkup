...
/*
  Blood Pressure MAIN PAGE for TABLET
*/
Page {
     ...
     Flickable {
            id: bloodPressurePageTabletFlickable
            clip: true
           ...
           Column{
                ...
                Row{
                 ...
                 Row{
                    ...
                    TextArea {
                        ...
                        height: units.gu(15)
                        width: inserValueRow.width - noteLabel.width - units.gu(2)
                        readOnly: false
                    }
                 }
                ...
                Row{
                    ...
                    Button {
                        ...
                        onClicked: {
                           pageStack.push(bloodAnaliticPage)
                        }
                    }
                }
   ...
   /* To show a scrolbar on the side */
    Scrollbar {
        flickableItem: bloodPressurePageTabletFlickable
