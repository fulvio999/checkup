            ...
            Column {
                ...
                Row{
                    ...
                    Label {
                          ...
                          anchors.verticalCenter: valueTextField.verticalCenter
                          text: glicemicDiaryPage.glicemicUnitOfMeasure
                          font.bold: true
                          fontSize: "medium"
                    }
                }
                ...
                Row{
                    ...
                    Button{
                      ...
                      enabled:false
                      onClicked: {
                          glicemicDiaryPage.itemNotes = notes;
              ...
              Row{
                  ...
                  Icon {
                      ...
                      MouseArea {
                          ...
                          onClicked: {
                              glicemicDiaryPage.selectedItem = id;
                  ...
                  Icon {
                        ...
                        MouseArea {
                            ...
                            onClicked: {
                                //update
                                glicemicDiaryPage.selectedItem = id;
                                GlicemicDao.updateGlicemicMeasure(valueTextField.text,glicemicDiaryPage.itemNotes, glicemicDiaryPage.selectedItem );
